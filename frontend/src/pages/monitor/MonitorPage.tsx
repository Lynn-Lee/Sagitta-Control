...
import { MonitorConfigModal } from './components/MonitorConfigModal'
...
export default function MonitorPage() {
  ...
  const {
    ...
    topSqlDateStart,
    topSqlDateEnd,
    topSqlRangeStartLabel: topSqlCustomRange?.[0]?.format(TOP_SQL_TIME_FORMAT),
    topSqlRangeEndLabel: topSqlCustomRange?.[1]?.format(TOP_SQL_TIME_FORMAT),
    canViewSql,
    tableDb,
    tableSearch,
    tablePage,
  ...
  return (
    <div>
      ...
      <MonitorConfigModal
        open={configOpen}
        scope={configScope}
        targetName={configTarget?.instance_name || active?.instance_name || ''}
        instancesCount={instances.length}
        form={form}
        isSaving={saveConfig.isPending || saveAllConfig.isPending}
